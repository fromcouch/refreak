...
<head>
	<title>Refreak</title>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>/theme/default/css/login.css" />
</head>
<body>
    
    <div class="container">
        <div class="horiz">
            <img src="<?php echo base_url(); ?>/theme/default/images/freak-logo.png" border="0" alt="Refreak" />
