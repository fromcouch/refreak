...
<body>
    ...
    <footer class="footer">
        ...
        ?>
            Refreak! <?php echo config_item('rfk_version'); ?> - <?php echo config_item('release_date'); ?> - <a href="https://github.com/fromcouch/refreak/issues/" target="_blank">Visit on Github</a>
    </footer>
